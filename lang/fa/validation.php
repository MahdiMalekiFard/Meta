...
return [
    ...
    */
    ...
    'ascii'                => 'گزینه :attribute باید تنها شامل کاراکتر های ASCII باشد',
    ...
    'key_order'            => 'ترتیب مراحل درست نمیباشد',
    'count_order'          => 'تعداد مراحل برای اپدیت کافی نمیباشد',
    ...
    */
    'attributes'           => [
        ...
        'captcha'                => 'کد امنیتی',
        'price'                  => 'قیمت',
        'price_special'          => 'قیمت تخفیفی',
        'pic'                    => 'تصویر',
        'link'                   => 'لینک',
        'user_uuid'              => 'ایدی کاربر',
        'is_customer'            => 'نوع مشتری',
        'has_application'        => 'اپلیکیشن دارد',
        'version_number'         => 'ورژن',
        'platform'               => 'نوع پلتفرم',
        'release_date'           => 'تاریخ انتشار',
        'download_url'           => 'لینک دانلود',
        'is_force'               => 'آیا ضروری است',
        'is_special'             => 'ویژه',
        'category'               => 'دسته بندی',
        'category_id'            => 'دستبه بندی',
        'is_filter'              => 'استفاده در فیلترها',
        'option_type'            => 'نوع ویژگی',
        'body'                   => 'توضیحات کامل',
        'attribute_id'           => 'ویژگی',
        'slug'                   => 'نامک',
        'image_uuid'             => 'تصویر',
        ...
        'slider_uuid'            => 'اسلایدر',
        'story_uuid'             => 'استوری',
        'mobile_image_uuid'      => 'تصویر موبایل',
        'tablet_image_uuid'      => 'تصویر تبلت',
        'product_uuid'           => 'کالا',
        'product'                => 'کالا',
        'extension'              => 'نوع',
        ...
        'mobile_prefix'          => 'کد کشور',
        'currency_id'            => 'واحد پولی',
        'location_province_uuid' => 'استان',
        'location_country_uuid'  => 'کشور',
        'branch_uuid'            => 'شعبه',
        'card_number'            => 'شماره کارت',
        'gateway_key'            => 'درگاه پرداخت',
        'iban'                   => 'شماره شبا',
        'users_uuid'             => 'کاربران',
        ...
        'account_uuid'           => 'گروه',
        'number'                 => 'شماره حساب',
        'created_date'           => 'تاریخ افتتاح',
        'first_balance_amount'   => 'موجودی اولیه',
        'first_balance_sign'     => 'ماهیت',
        'has_gateway'            => 'درگاه پرداخت',
        'gateway_info'           => 'اطلاعات درگاه پرداخت',
        'order_number'           => 'کد فاکتور',
        'sku'                    => 'کد انبار',
        'id'                     => 'کد ',
        'receiver'               => 'دریافت کننده',
        'total_price'            => 'قیمت کل',
        'payment_type'           => 'نوع پرداخت',
        'bank_price'             => 'هزینه بانک',
        'start_at'               => 'آغاز',
        'ended_at'               => 'پایان',
        'pin'                    => 'سنجاق',
        'case_uuid'              => 'ایدی پرونده',
        'known_type'             => ' نحوه اشنایی',
        'customer_type'          => ' نحوه فروش',
        'note'                   => 'یادداشت',
        'plan'                   => 'رتبه بندی',
        'marketer'               => 'بازاریاب',
        'message'                => 'پیام',
        'ticket'                 => 'تیکت',
        'delete_reason_uuid'     => 'دلیل حذف',
        'subject'                => 'عنوان',
        'department'             => 'دپارتمان',
        'priority'               => 'میزان الویت ',
        ...
        'address'                => 'آدرس',
        'bio'                    => 'بیوگرافی',
        'enable_notification'    => 'فعال سازی اعلان',
        'enable_subscription'    => 'فعال سازی اشتراک',
        'service_id'             => 'سرویس',
        'domain_name'            => 'دامنه',
    ],
