...
<div class="app-navbar flex-shrink-0">
    <!--begin::Search-->
    <div class="app-navbar-item align-items-stretch ms-1 ms-md-4" hidden>
        @include('admin.partials.search._dropdown')
    </div>
    <!--end::Search-->
    <!--begin::Activities-->
    <div class="app-navbar-item ms-1 ms-md-4" hidden>
        <!--begin::Drawer toggle-->
    ...
    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-35px"
            ...
            <img src="/assets/media/logos/logo-square.jpg" class="rounded-3" alt="user"/>
        </div>
