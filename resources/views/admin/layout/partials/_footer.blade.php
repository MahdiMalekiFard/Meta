...
<div id="kt_app_footer" class="app-footer ">
    ...
    <div class="app-container  container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3 ">
        ...
        <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
            ...
            <li class="menu-item"><a href="/docs" target="_blank" class="menu-link px-2">Developer Docs</a></li>
            <li class="menu-item"><a href="/telescope" target="_blank" class="menu-link px-2">Telescope</a></li>
            <li class="menu-item"><a href="/horizon" target="_blank" class="menu-link px-2">Horizon</a></li>
            @endif
