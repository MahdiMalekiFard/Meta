                        ...
                        <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                            ...
                            <div class="d-flex align-items-center me-5 me-xl-13">
                                ...
                                <div class="symbol symbol-30px symbol-circle me-3">
                                    <img src="/assets/media/logos/logo-square.jpg" class="" alt=""/>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Info-->
                                <div class="m-0">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-30px symbol-circle me-3">
                                    <span class="symbol-label bg-success">
                                        <i class="ki-solid ki-abstract-41 fs-5 text-white"></i>                                    </span>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Info-->
                                <div class="m-0">
                    ...
                    <div class="d-flex flex-stack mt-auto bd-highlight">
                        ...
                        <div class="symbol-group symbol-hover flex-nowrap">
                            ...
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
                                <img alt="Pic" src="/assets/media/logos/logo-square.jpg"/>
                            </div>
                        ...
                        <a href="?page=apps/projects/project" class="d-flex align-items-center text-primary opacity-75-hover fs-6 fw-semibold">
                            View Project
                            <i class="ki-solid ki-exit-right-corner fs-4 ms-1"></i>
                        </a>
                        <!--end::Actions-->
                    </div>
                    <!--end::Footer-->
