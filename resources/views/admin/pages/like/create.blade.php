<x-admin.layout.master
    ...
    :title="trans('general.page.create.page_title',['model'=>trans('like.model')])">
    <x-admin.widget.form-card
        :title="trans('general.page.create.title',['model'=>trans('like.model')])"
        :action="route('admin.like.store')">
