        ...
        <td>
          ...
          Description: This email is sent when someone signs up or updates their email for a centralized Teachable Account.
           ...
           -->
                            ...
                            <h1 style="direction:rtl;text-align: right;font-family:&quot;Rubik sans-serif&quot;, Rubik, Arial, &quot;Lucida Grande&quot;, sans-serif;margin-bottom:15px;color:limegreen;margin:0px 0 10px;line-height:1.2;font-weight:200;font-size:20px;font-weight:bold;margin-bottom:30px;">سامانه شما با موفقیت ایجاد گردید</h1>
                            ...
                            <p style="direction:rtl;font-weight:normal;padding:0;font-family:&quot;Rubik sans-serif&quot;, &quot;Rubik&quot;, Rubik, Arial, sans-serif;line-height:1.7;margin-bottom:1.3em;font-size:15px;color:#47505E;float: right">
                                برای ورود به سامانه، از لینک و اطلاعات کاربری زیر استفاده کنید
                            </p>
                           ...
                           <div style="direction: rtl">
                               <a href="{{$website_url}}"
                                  style="display:inline-block;color: rgb(102, 102, 102); -webkit-text-decoration-color: rgba(102, 102, 102, 0.258824);">ورود به سامانه</a>
                               <ul style="list-style: none;padding: 0px;display:flex;flex-direction: column;row-gap: 5px;">
                                   <li style="display: flex;justify-content: space-between"><strong>نام کاربری: </strong>{{$username}}</li>
                                   <li style="display: flex;justify-content: space-between"><strong>پسورد: </strong>{{$password}}</li>
                               </ul>
                           </div>
